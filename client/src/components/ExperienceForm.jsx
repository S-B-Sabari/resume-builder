...
const ExperienceForm = ({ data = [], onChange }) => {
    ...
    const enhanceDescriptionWithAI = async (index) => {
        const currentDescription = data[index].description;
        if (!currentDescription) {
            toast.error("Please provide some initial description to enhance.");
            return;
        }
        ...
        try {
            ...
            const response = await api.post('/api/ai/enhance-job-desc',
                { userContent: `enhance my job description: "${currentDescription}"` },
