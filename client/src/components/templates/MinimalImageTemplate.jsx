            ...
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-6">
                            <img src={data.personal_info.image} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: removeBackground ? accentColor + '70' : 'transparent' }} />
                        </div>
                    ) : (
                        data.personal_info?.image && typeof data.personal_info.image === 'object' ? (
                            <div className="mb-6">
                                <img src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: removeBackground ? accentColor + '70' : 'transparent' }} />
                            </div>
                        ) : null
                    )}
                </div>
                            ...
                            <div className="space-y-6 mb-8">
                                {data.experience.map((exp, index) => (
                                    <div key={index}>
                                        ...
                                        {exp.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700 leading-relaxed space-y-1 whitespace-pre-wrap break-words">
                            ...
                            <div className="space-y-4">
                                {data.project.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        {project.description && (
                                            <ul className="list-disc list-inside text-sm text-zinc-700 space-y-1 whitespace-pre-wrap break-words">
